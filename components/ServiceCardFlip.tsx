        ...
        >
          ...
          <div className="relative h-full overflow-hidden">
            ...
            <div className="absolute top-0 left-0 right-0 flex justify-center pt-12">
              <div className={`w-20 h-20 bg-gradient-to-br ${gradient} rounded-2xl flex items-center justify-center text-4xl shadow-lg transition-transform duration-300 group-hover:scale-110`}>
                {icon}
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <div className="relative h-24 w-full bg-slate-800">
                      <Image
                        ...
                        alt={example.title}
                        fill
                        className="object-cover opacity-70 hover:opacity-100 hover:scale-110 transition-all duration-300"
                      />
